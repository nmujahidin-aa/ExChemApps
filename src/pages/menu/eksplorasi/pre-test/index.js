    ...
    >
      <View style={{flex: 1, alignItems: "center", justifyContent: "center"}}>
        ...
        <View style={styles.points}>
          <Text style={{color: "#000", fontSize: 40, fontWeight: "bold",}}>{totalPoints*10}</Text>
        </View>
        <View style={{ alignItems: 'center', justifyContent:'center'}}>
          {totalPoints > 0 ? (
            
            <Text style={styles.text}>Anda sudah mengerjakan Pre-Test{'\n'}Point Anda Sebelumnya{'\n'} <Text style={{fontSize: 30,}}>{totalPoints*10}/100</Text> </Text>
          ) : (
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.replace('SoalPretest')}
          >
