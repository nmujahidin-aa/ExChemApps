...
const VideoPembelajaranDetail = ({ route }) => {
  ...
  useEffect(() => {
    const fetchVideoData = async () => {
      try {
        ...
        const videoCollectionRef = collection(FIRESTORE_DB, 'Video Pembelajaran'); // Reference to the collection
        const videoDocRef = doc(videoCollectionRef, videoId); // Reference to the specific document
...
export default VideoPembelajaranDetail;
