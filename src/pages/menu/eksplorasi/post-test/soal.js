...
import data from '../../../../data/postest/data';
...
const SoalPosttest = () => {
    ...
    const saveScoreToFirestore = async (uid, score) => {
        ...
        // Simpan skor ke dalam kolom totalPointsPostTest
        await updateDoc(userDocRef, {
            totalPointsPostTest: score,
        });
            ...
            visible={showScoreModal}>
                ...
                <View
                    ...
                    <View style={styles.points}>
                        <Text style={{ color: '#000', fontSize: 12 }}>Nilai Post Test kamu</Text>
                        <Text
                            style={{
                            fontSize: 60,
                            fontWeight: 'bold',
                    ...
                    <Text style={{textAlign: "center", color: "#000",}}>Kamu telah berhasil menyelesaikan post test, apapun hasilnya kamu harus tetap belajar lagi ya!</Text>
                    <TouchableOpacity
